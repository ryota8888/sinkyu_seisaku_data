...
(106, '朝顔', 'ハナエ', 'asagao_hanae', 4, 2, 3, 2, 5, 2, 1, 2, 3, 1, 1000, 2, 31, 22, '15才', '05/12', '150cm'),
...
(118, '若葉', 'ヒナタ', 'wakaba_hinata', 4, 1, 2, 5, 1, 3, 3, 2, 2, 3, 650, 3, 31, 18, '17才', '05/17', '166cm'),
...
(126, '朝比奈', 'フィーナ', 'asahina_fina', 2, 1, 3, 2, 3, 4, 2, 1, 2, 5, 750, 1, 32, 26, '17才', '11/03', '165cm'),
(127, '愛清', 'フウカ', 'aikiyo_huka', 5, 2, 3, 2, 2, 4, 1, 2, 3, 4, 1000, 2, 33, 9, '16才', '04/30', '159cm'),
...
(141, '才羽', 'ミドリ', 'saiba_midori', 6, 1, 3, 3, 1, 5, 2, 1, 2, 2, 750, 3, 34, 30, '15才', '12/08', '143cm'),
...
(146, '水羽', 'ミモリ', 'mizuha_mimori', 2, 1, 2, 1, 5, 3, 3, 1, 4, 3, 550, 3, 35, 28, '16才', '03/15', '156cm'),
(147, '水羽', 'ミモリ', 'mizuha_mimori_summer', 2, 2, 3, 3, 5, 1, 3, 3, 4, 3, 1000, 3, 35, 28, '16才', '03/15', '156cm'),
...
(155, '姫木', 'メル', 'himeki_meru', 3, 1, 2, 3, 1, 5, 2, 1, 2, 3, 550, 3, 36, 38, '16才', '12/21', '137cm'),
(156, '風倉', 'モエ', 'kazekura_moe', 8, 2, 3, 5, 3, 1, 2, 1, 2, 3, 1000, 3, 1, 40, '15才', '09/13', '163cm'),
(157, '秋泉', 'モミジ', 'akiizumi_momiji', 3, 1, 3, 2, 2, 5, 4, 2, 2, 10, 850, 2, 34, 38, '15才', '08/07', '135cm'),
(158, '才羽', 'モモイ', 'saiba_momoi', 6, 1, 2, 2, 2, 5, 2, 1, 2, 1, 650, 2, 34, 30, '15才', '12/08', '143cm'),
...
(165, '朱城', 'ルミ', 'akeshiro_rumi', 9, 1, 1, 4, 4, 1, 1, 2, 3, 4, 450, 3, 37, 15, '17才', '03/05', '168cm'),
